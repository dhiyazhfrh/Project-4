        ...
        <a href="Input_schedule.php">
            ...
            <table class="content-table">
                ...
                <tr>
                    ...
                    <td><div class="action">
                      <a href="edit_schedule.php?id=<?php echo $schedule['time_id'];?>"><img class="edit" src="img/edit.svg"></a>
                      <a href="delete_schedule.php?id=<?php echo $schedule['time_id'];?>"><img class="delete" src="img/delete.svg"></div></td>
                </tr>
                <tbody>
                <?php
                    }
